...
<body class="bg-oranje">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        if($account->post_control([$_POST["wachtwoord"], $_POST["naam"],$_POST["herhaal_wachtwoord"]]))
        {
    ...
    <form action="registreer_uitgebreid.php" method="post">
    <div class="mb-3">
            <label for="email" class="form-label">Email:</label>
            <input type="email" name = "email" class="form-control" id="email" placeholder="Vul uw email in" value="<?php echo htmlspecialchars(isset($_POST['naam'])&&!empty($_POST['naam'])?$_POST['naam']:"");?>">
        </div>
        <div class="mb-3">
        ...
        <a href="login_uitgebreid.php" class="btn btn-warning mb-3">Inloggen</a>
    </form>
    </div>
